...
/**
 * @file brand
 * @description Single source of truth for the EvTag (اوتاگ) brand identity.
 ...
 *
 * Brand: EvTag (اوتاگ) — "one of a kind" / یکتا
 *
 * @status None
 * @issues None
 * @todo None
...
export const BRAND_NAME_FA = 'اوتاگ'
...
export const BRAND_DOCUMENT_TITLE = 'اوتاگ — زیورآلات نقرهٔ دست\u200cساز'
